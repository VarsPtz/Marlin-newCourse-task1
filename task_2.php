<?php
  $bloksOfArticle = [
    ...
    [
      "header" => [
        "headerDimension" => 3,
        "headerTitle" => "Cookies and other similar technologies"
      ],
      ...
      <div class="panel-container show">
        <div class="panel-content">
          <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
            <?php foreach ($bloksOfArticle as $block): ?>
              <h<?php echo $block["header"]["headerDimension"]; ?>><?php echo $block["header"]["headerTitle"]; ?></h<?php echo $block["header"]["headerDimension"]; ?>>
